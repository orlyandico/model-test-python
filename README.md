...
- **DeepSeek V3.2 underperforms expectations:** At F1 0.782 and 5.27s latency, it ranks below smaller local models. This is likely due to limited capacity or throttling on the Bedrock endpoint rather than model capability, as DeepSeek models generally perform well on reasoning tasks.
